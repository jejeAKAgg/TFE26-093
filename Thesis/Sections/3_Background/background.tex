...
Since then, GGP research has expanded toward increasingly diverse game domains, including video games through the General Video Game AI (GVGAI) framework\cite{Genesereth2005GeneralGP}, stochastic games, multi-player environments, and modern board games.
...
\subsection{Random Mutation Hill Climber (RMHC)}
